...
await page.goto(`${base}/?room=VIEW${Date.now() % 10000}&name=Viewer&renderEvery=100000`);
...
await page.evaluate(() => game.send({ t: 'debug', do: 'god' }));
...
for (const [i, v] of views.entries()) {
	...
	await page.screenshot({ path: `${outDir}/${prefix}${i}.png`, timeout: 120000 });
